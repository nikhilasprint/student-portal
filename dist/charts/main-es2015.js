...
module.exports = __webpack_require__(/*! /Users/od485251/Desktop/student-portal/src/main.ts */"zUnb");
...
/* harmony import */ var _mockData__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../mockData */ "VHO5");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _student_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../student.service */ "exjJ");
...
function PieChartComponent_div_8_Template(rf, ctx) { if (rf & 1) {
...
class PieChartComponent {
    constructor(studentService, router) {
        ...
        const studentGrades = this.studentService.getGradePercentage(_mockData__WEBPACK_IMPORTED_MODULE_2__["STUDENTS"]);
        ...
        this.openform = new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormGroup"]({
            name: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"]("", _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].compose([
                ...
                _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].pattern("[a-z]{1,8}")
            ])),
            id: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"]("", _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].compose([
                _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required,
                _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].pattern("[a-z]{1,8}")
            ])),
            grade: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"]("", _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].compose([
                _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required,
                _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].pattern("[a-z]{1,8}")
            ])),
            maths: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"]("", _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].compose([
                _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required,
                _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].pattern("[a-z]{1,8}")
            ])),
            english: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"]("", _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].compose([
                _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required,
                _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].pattern("[a-z]{1,8}")
            ])),
            social: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"]("", _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].compose([
                _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required,
                _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].pattern("[a-z]{1,8}")
            ]))
        });
    ...
    chartClicked(e) {
        ...
        if (e.active.length > 0) {
            ...
            if (activePoints.length > 0) {
                ...
                this.listOfStudents = this.getMockData.filter((data) => data.grade === label);
...
PieChartComponent.ɵfac = function PieChartComponent_Factory(t) { return new (t || PieChartComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_student_service__WEBPACK_IMPORTED_MODULE_4__["StudentService"]), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"])); };
PieChartComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({ type: PieChartComponent, selectors: [["app-pie-chart"]], decls: 11, vars: 9, consts: [[1, "landing-page"], [1, "chart-wrapper"], ["baseChart", "", 3, "data", "labels", "chartType", "options", "plugins", "legend", "chartClick"], [1, "openform", "form-custom", 3, "hidden"], [1, "row"], [1, "col-xs-12", 3, "formGroup"], ["class", "form-row form-custom", 4, "ngFor", "ngForOf"], ["type", "submit", 1, "btn", "btn-primary"], [1, "form-row", "form-custom"], [1, "form-group", "col-xs-2"], ["for", "name"], ["type", "text", "formControlName", "name", 1, "form-control", 3, "ngModel"], [1, "form-group", "col-xs-1"], ["for", "id"], ["type", "text", "formControlName", "id", 1, "form-control", 3, "ngModel"], ["for", "grade"], ["type", "text", "formControlName", "grade", 1, "form-control", 3, "ngModel"], ["for", "english"], ["type", "text", "formControlName", "english", 1, "form-control", 3, "ngModel"], ["for", "maths"], ["type", "text", "formControlName", "maths", 1, "form-control", 3, "ngModel"], ["for", "social"], ["type", "text", "formControlName", "social", 1, "form-control", 3, "ngModel"]], template: function PieChartComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("chartClick", function PieChartComponent_Template_canvas_chartClick_4_listener($event) { return ctx.chartClicked($event); });
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
...
function StudentSummaryComponent_tr_24_div_4_Template(rf, ctx) { if (rf & 1) {
    const _r10 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 11);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function StudentSummaryComponent_tr_24_div_4_Template_div_click_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r10); const entity_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit; const ctx_r8 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r8.editAge(entity_r1); });
...
function StudentSummaryComponent_tr_24_input_5_Template(rf, ctx) { if (rf & 1) {
    const _r15 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "input", 12, 13);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function StudentSummaryComponent_tr_24_input_5_Template_input_ngModelChange_0_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r15); const entity_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit; return entity_r1.age = $event; })("focusout", function StudentSummaryComponent_tr_24_input_5_Template_input_focusout_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r15); const entity_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit; const ctx_r16 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r16.hideShowAge(entity_r1); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
    const entity_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
...
function StudentSummaryComponent_tr_24_div_7_Template(rf, ctx) { if (rf & 1) {
    const _r21 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 14);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function StudentSummaryComponent_tr_24_div_7_Template_div_click_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r21); const entity_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit; const ctx_r19 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r19.editEmail(entity_r1); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
    const entity_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
...
function StudentSummaryComponent_tr_24_input_8_Template(rf, ctx) { if (rf & 1) {
    const _r26 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "input", 15, 16);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function StudentSummaryComponent_tr_24_input_8_Template_input_ngModelChange_0_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r26); const entity_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit; return entity_r1.email = $event; })("focusout", function StudentSummaryComponent_tr_24_input_8_Template_input_focusout_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r26); const entity_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit; const ctx_r27 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r27.hideShowEmail(entity_r1); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
    const entity_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
...
function StudentSummaryComponent_tr_24_span_9_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span", 17);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "Please provide a valid email!");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function StudentSummaryComponent_tr_24_Template(rf, ctx) { if (rf & 1) {
...
StudentSummaryComponent.ɵfac = function StudentSummaryComponent_Factory(t) { return new (t || StudentSummaryComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_student_service__WEBPACK_IMPORTED_MODULE_1__["StudentService"])); };
StudentSummaryComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: StudentSummaryComponent, selectors: [["app-student-summary"]], decls: 25, vars: 1, consts: [[1, "table"], [1, "aspen"], ["colspan", "2"], ["colspan", "5"], [4, "ngFor", "ngForOf"], [3, "click", 4, "ngIf"], ["type", "text", 3, "id", "ngModel", "placeholder", "ngModelChange", "focusout", 4, "ngIf"], [1, "email-col"], ["id", "email", 3, "click", 4, "ngIf"], ["type", "text", 3, "ngModel", "placeholder", "ngModelChange", "focusout", 4, "ngIf"], ["class", "error email-error", 4, "ngIf"], [3, "click"], ["type", "text", 3, "id", "ngModel", "placeholder", "ngModelChange", "focusout"], ["age", ""], ["id", "email", 3, "click"], ["type", "text", 3, "ngModel", "placeholder", "ngModelChange", "focusout"], ["email", ""], [1, "error", "email-error"]], template: function StudentSummaryComponent_Template(rf, ctx) { if (rf & 1) {
...
/* harmony import */ var _student_summary_student_summary_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./student-summary/student-summary.component */ "2EF8");
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"],
        ...
        _student_summary_student_summary_component__WEBPACK_IMPORTED_MODULE_7__["StudentSummaryComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
        _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"],
        _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_5__["BrowserAnimationsModule"],
        ng2_charts__WEBPACK_IMPORTED_MODULE_1__["ChartsModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_6__["ReactiveFormsModule"],
...
/* harmony import */ var _mockData__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./mockData */ "VHO5");
...
class StudentService {
    ...
    getGradePercentage(studentData) {
        const totalStudents = studentData.length;
        const studentGrades = studentData.reduce((val, curr) => {
            if (val[curr.grade]) {
                val[curr.grade] += 1;
            }
            else {
...
/* harmony import */ var _pie_chart_pie_chart_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./pie-chart/pie-chart.component */ "1U8D");
/* harmony import */ var _student_summary_student_summary_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./student-summary/student-summary.component */ "2EF8");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ "fXoL");
...
const routes = [
    { path: '', component: _pie_chart_pie_chart_component__WEBPACK_IMPORTED_MODULE_1__["PieChartComponent"] },
    { path: 'studentSummary', component: _student_summary_student_summary_component__WEBPACK_IMPORTED_MODULE_2__["StudentSummaryComponent"] },
];
